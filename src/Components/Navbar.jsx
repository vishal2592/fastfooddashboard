        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              >
                <img
                  src="https://ui-avatars.com/api/?name=Admin&background=7C3AED&color=fff&size=36"
                  alt="Profile"
                  className="w-8 h-8 rounded-full ring-2 ring-purple-500/40"
                />
                <div className="hidden md:block text-left">
                  <p className="text-sm font-medium text-gray-200 leading-none">Admin</p>
                  <p className="text-xs text-gray-400 leading-none mt-0.5">Administrator</p>
                </div>
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-[#141824] border border-white/10 rounded-xl shadow-2xl py-2 z-50">
                  <div className="px-4 py-2 border-b border-white/5">
                    ...
                    <p className="text-xs text-gray-400">admin@fastfood.com</p>
                  </div>
                  <div className="py-1">
                    <DropdownItem 
                      icon={<User size={16} />} 
...
// Dropdown Item component – now supports navigation via `to` prop
const DropdownItem = ({ icon, label, className = '', to, onClick }) => {
  const content = (
    <>
